...
(function() {
  ...
  geom.twiceSignedArea = function(points) {
    ...
    return ((function() {
      ...
      for (i = j = 0, len = points.length; j < len; i = ++j) {
        v = points[i];
        results.push(geom.twiceSignedArea([v, points[geom.next(i, points.length)]]));
      }
      return results;
    })()).reduce(geom.sum);
  };
  ...
  geom.segmentsCross = function(arg, arg1) {
    ...
    p0 = arg[0], q0 = arg[1];
    p1 = arg1[0], q1 = arg1[1];
    if (geom.rangesDisjoint([p0[0], q0[0]], [p1[0], p2[0]]) || geom.rangesDisjoint([p0[1], q0[1]], [p1[1], p2[1]])) {
      return false;
    }
...
(function() {
  ...
  viewer.appendSVG = function(svg, tag, attrs) {
    return svg.appendChild(setAttrs(document.createElementNS(SVGNS, tag), attrs));
  };
  ...
  viewer.addRotation = function(svg, cam) {
    var len, o, ref, s;
    ...
    svg.mousedown((function(_this) {
      return function(e) {
        return cam.last = [e.clientX, e.clientY];
      };
    })(this));
    svg.mousemove((function(_this) {
      return function(e) {
        return viewer.rotateCam([e.clientX, e.clientY]);
      };
    })(this));
    return svg.mouseup((function(_this) {
      return function(e) {
        viewer.rotateCam([e.clientX, e.clientY]);
        return cam.last = null;
      };
    })(this));
  };

  viewer.rotateCam = function(p, cam) {
    var c, d, ref, u, x, y;
    if (cam.last == null) {
      return;
    }
    ...
    ref = (function() {
      ...
      for (o = 0, len = ref.length; o < len; o++) {
        c = ref[o];
        results.push(geom.rot(cam[c], u, geom.mag(d) * 0.01));
      }
      return results;
    })(), x = ref[0], y = ref[1];
    viewer.setCamXY(x, y);
  ...
  viewer.makeModel = function(fold) {
    var a, aa, ab, b, cs, f, i, j, l, len, len1, len2, len3, len4, len5, m, o, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, v, vs, w, z;
    m = {
      vs: null,
      fs: null,
      es: {}
    ...
    ref6 = m.fs;
    for (i = aa = 0, len4 = ref6.length; aa < len4; i = ++aa) {
      f = ref6[i];
      m.fs[i].n = geom.triangleNormal((function() {
        var ab, len5, ref7, results;
        ref7 = f.vs;
        results = [];
        for (ab = 0, len5 = ref7.length; ab < len5; ab++) {
          v = ref7[ab];
          results.push(v.cs);
        }
        return results;
      ...
      m.fs[i].es = {};
      m.fs[i].es = (function() {
        var ab, len5, ref7, ref8, results;
        ref7 = f.vs;
        results = [];
        for (j = ab = 0, len5 = ref7.length; ab < len5; j = ++ab) {
          v = ref7[j];
          w = f.vs[geom.next(j, f.vs.length)];
  ...
  viewer.draw = function(model, arg) {
    var c, cam, e, f, g, i, j, k, len, len1, len2, len3, max, min, o, pc, q, r, ref, ref1, ref2, ref3, ref4, results, svg, t, v, z;
    svg = arg.svg, cam = arg.cam;
    svg.empty();
    ref = viewer.STYLES;
    for (k in ref) {
      v = ref[k];
      viewer.appendSVG(svg, 'style', {
        id: k
      }).html("." + k + "{" + v + "}");
    }
    min = (function() {
      var len, o, ref1, results;
      ref1 = [0, 1, 2];
      results = [];
      for (o = 0, len = ref1.length; o < len; o++) {
        i = ref1[o];
        results.push(((function() {
          var len1, q, ref2, results1;
          ref2 = model.vs;
          results1 = [];
    ...
    for (i = o = 0, len = ref1.length; o < len; i = ++o) {
      ...
      ref2 = f.es;
      for (j = q = 0, len1 = ref2.length; q < len1; j = ++q) {
        e = ref2[j];
        if (e.path == null) {
      ...
      ref3 = f.vs;
      for (j = r = 0, len2 = ref3.length; r < len2; j = ++r) {
        v = ref3[j];
        if (!(v.path == null)) {
          continue;
        }
  ...
  viewer.update = function(arg) {
    var aa, ab, attr, c, cam, e, end, f, i, j, len, len1, len2, len3, len4, len5, model, o, p, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, results, show, svg, v, visibleSide, z;
    model = arg.model, cam = arg.cam, svg = arg.svg;
    ref = model.vs;
    for (i = o = 0, len = ref.length; o < len; i = ++o) {
      v = ref[i];
      model.vs[i].ps = proj(v.cs, cam);
    }
    ref1 = model.fs;
    for (i = q = 0, len1 = ref1.length; q < len1; i = ++q) {
      f = ref1[i];
      model.fs[i].c2 = proj(f.c, cam);
    }
    ...
    for (i = z = 0, len3 = ref3.length; z < len3; i = ++z) {
      ...
      ref4 = f.es;
      for (j = aa = 0, len4 = ref4.length; aa < len4; j = ++aa) {
        e = ref4[j];
        setAttrs(e.path, {
      ...
      ref5 = f.vs;
      for (j = ab = 0, len5 = ref5.length; ab < len5; j = ++ab) {
        v = ref5[j];
        setAttrs(v.path, {
          cx: v.ps[0],
          cy: v.ps[1],
    ...
    for (c in ref6) {
      ...
      results.push(setAttrs(document.getElementById("a" + c), {
        d: viewer.makePath((function() {
          var ac, len6, ref7, results1;
          ref7 = [cam.c, end];
          results1 = [];
          for (ac = 0, len6 = ref7.length; ac < len6; ac++) {
            p = ref7[ac];
